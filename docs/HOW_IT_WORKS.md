...
- SMS/email реально не отправляются;
- нет HTTPS;
- нет полноценной панели администратора БД;
...
6. Добавить визуальный способ смотреть БД, например Adminer или pgAdmin.
7. Добавить резервные копии PostgreSQL.
8. Подключить домен.
9. Подключить HTTPS.
10. Подключить настоящую отправку кода через email или SMS.
11. Заменить открытое хранение кодов/токенов на хешированное.
