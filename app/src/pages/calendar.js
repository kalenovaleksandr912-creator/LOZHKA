import { agenda, calendarWeek, tomorrowAgenda } from "../data/mock-data.js?v=19";
import { agendaCard, escapeHtml, icon, pageShell, sectionTitle } from "../components/html.js?v=19";
