import { carouselCards, dailyPhoto, meals, shopping, tasks as mockTasks, today, todayEvents } from "../data/mock-data.js?v=19";
import { agendaCard, escapeHtml, icon, pageShell } from "../components/html.js?v=19";
